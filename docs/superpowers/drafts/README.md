...
- **Single sign-on (overnight M17, §2 and §4).** Built as M16: [`specs/2026-09-22-m16-sso-design.md`](../specs/2026-09-22-m16-sso-design.md). The same draft's group-scoped administrators (§3) were built as M18: [`specs/2026-09-23-m18-scoped-admins-design.md`](../specs/2026-09-23-m18-scoped-admins-design.md).
