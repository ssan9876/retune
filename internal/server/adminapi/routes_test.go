...
var expectedRoutes = map[string]string{
	...
	"DELETE /api/admin/v1/maintenance-windows/{id}":                 "fleet+write",
	"DELETE /api/admin/v1/reports/{id}":                             "fleet+write",
	"DELETE /api/admin/v1/device-registrations/{id}":                "fleet+write",
	"GET /api/admin/v1/device-registrations":                        "fleet",
	"POST /api/admin/v1/device-registrations":                       "fleet+write",
	"POST /api/admin/v1/device-registrations/import":                "fleet+write",
	"GET /api/admin/v1/reports":                                     "fleet",
	"GET /api/admin/v1/reports/{id}":                                "fleet",
	"POST /api/admin/v1/reports":                                    "fleet+write",
	"POST /api/admin/v1/reports/{id}":                               "fleet+write",
	"POST /api/admin/v1/reports/{id}/send":                          "fleet+write",
	...
	"GET /api/admin/v1/agent-rollout":                               "scoped",
	"GET /api/admin/v1/releases":                                    "scoped",
	"GET /api/admin/v1/server":                                      "scoped",
	...
	"GET /api/admin/v1/approvals":                                   "admin",
	...
	"GET /api/admin/v1/maintenance-windows":                         "scoped",
	"GET /api/admin/v1/maintenance-windows/{id}":                    "scoped",
	...
	"GET /api/admin/v1/devices/{id}/remote-sessions":                "session+write",
	"GET /api/admin/v1/remote-sessions/{id}":                        "session+write",
	"POST /api/admin/v1/devices/{id}/remote-sessions":               "session+write",
	"POST /api/admin/v1/remote-sessions/{id}/end":                   "session+write",
	"POST /api/admin/v1/remote-sessions/{id}/input":                 "session+write",
	...
	"GET /api/admin/v1/devices/{id}/admin-passwords":                "scoped",
	...
	"POST /api/admin/v1/agent-rollout/policy":                       "fleet+write",
	"POST /api/admin/v1/agent-rollouts/{id}/resume":                 "fleet+write",
	"POST /api/admin/v1/releases/check":                             "fleet+write",
	"POST /api/admin/v1/server/update":                              "admin+write",
	...
	"POST /api/admin/v1/approvals/{id}/approve":                     "admin+write",
	"POST /api/admin/v1/approvals/{id}/reject":                      "admin+write",
	...
	"POST /api/admin/v1/maintenance-windows":                        "fleet+write",
	"POST /api/admin/v1/maintenance-windows/{id}":                   "fleet+write",
